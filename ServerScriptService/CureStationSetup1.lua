...
-- CureStationSetup (Script)

if workspace:GetAttribute("CureStationsInitialized") then
	warn("[CureStationSetup] Already initialized; skipping")
	return
end
workspace:SetAttribute("CureStationsInitialized", true)
